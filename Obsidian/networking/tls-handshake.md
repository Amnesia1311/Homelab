# TLS Handshake
In a TLS/SSL handshake, clients and servers exchange **SSL certificates([[ssl-certs]])**, cipher suite requirements, and randomly generated data for creating session keys.
